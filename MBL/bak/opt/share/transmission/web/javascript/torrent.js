	...
	****/
	...
	getStateString: function() {
		switch(this.getStatus()) {
			case Torrent._StatusStopped:        return this.isFinished() ? '做种完成' : '已暂停';
			case Torrent._StatusCheckWait:      return '等待效验';
			case Torrent._StatusCheck:          return '正在效验';
	...
	getErrorMessage: function() {
		...
		switch(this.getError()) {
			case Torrent._ErrTrackerWarning:
				return '来自Tracker的警告信息: ' + str;
			case Torrent._ErrTrackerError:
				return '来自Tracker的错误信息: ' + str;
