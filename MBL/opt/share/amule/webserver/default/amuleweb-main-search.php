...
<input type="hidden" name="command" value=""> 
                    ...
                    <input name="Search" type="submit" id="Search4" value="搜索" onClick="javascript:formCommandSubmit('search');"></td>
                  <td align="right">资源 :</td>
                  <td align="left"> 
                    <input name="avail" type="text" id="avail13" size="6"></td>
                  <td align="left">最小文件 : </td>
                  <td align="left">
<input name="minsize" type="text" id="minsize2" size="5"> 
                ...
                <tr> 
                  <td align="center"><a href="amuleweb-main-search.php?search_sort=<?php echo($HTTP_GET_VARS["sort"]);?>">点击这里更新搜索结果</a> </td>
...
<input name="maxsize" type="text" id="maxsize4" size="5"> 
              ...
              <table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
                  <th>&nbsp;</th>
                  <th><a href="amuleweb-main-search.php?sort=name">文件名</a></th>
                  <th><a href="amuleweb-main-search.php?sort=size">大小</a></th>
                  <th><a href="amuleweb-main-search.php?sort=sources">资源</a></th>
    ...
    <tr align="right"> 
      <td colspan="4" scope="col">
        <input name="Download" type="submit" id="Download6" value="下载" onClick="javascript:formCommandSubmit('download');" >
