...
<html>
<head>
<title>aMule汉化by:xiaomaoshou</title>
  ...
  <tr valign="top"> 
    ...
    <td width="100%" height="64" align="right" background="images/fond_haut.png"> <table border="0" cellspacing="0" cellpadding="0">
        <tr> 
          ...
          <td width="10"></td>
          <td width="190" align="right" class="texteinv"><a href="login.php">退出</a><br> 
            <a href="amuleweb-main-log.php">日志 &bull;</a> <a href="amuleweb-main-prefs.php">设置</a></td>
          <td width="10"></td>
        </tr>
      </table></td>
  </tr>
      ...
      <td width="50%" rowspan="3"> 
        <table width="350" border="0" align="center" cellpadding="0" cellspacing="0" >
          ...
          <tr> 
            ...
            <td height="25"> 检查可用空间 =&gt; 最小可用空间 (Mb) </td>
            <td width="63" height="25"> 
