...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr align="center" valign="top"> 
    <td colspan="2"><form name="mainform" action="amuleweb-main-shared.php" method="post">
        ...
        共享文件 
          ...
          <td bgcolor="#FFFFFF">
              <table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
                <tr> 
                  <th></th>
                  <th><a href="amuleweb-main-shared.php?sort=name">文件名</a></th>
                  <th><a href="amuleweb-main-shared.php?sort=xfer">转移</a> 
                    (<a href="amuleweb-main-shared.php?sort=xfer_all">总计</a>)</th>
                  <th><a href="amuleweb-main-shared.php?sort=req">请求</a> 
                    (<a href="amuleweb-main-shared.php?sort=req_all">总计</a>)</th>
                  <th><a href="amuleweb-main-shared.php?sort=acc">接受请求</a> 
                    (<a href="amuleweb-main-shared.php?sort=acc_all">总计</a>)</th>
                  <th><a href="amuleweb-main-shared.php?sort=size">大小</a></th>
                  <th><a href="amuleweb-main-shared.php?sort=prio">优先级</a></th>
		...
		{
			$prionames = array(0 => "低", 1 => "中", 2 => "高",
				3 => "非常高", 4 => "非常低", 5=> "自动", 6 => "释放");
