    ...
    <td colspan="2">        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr> 
            ...
            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr valign="top"> 
                  <td>
		<h1 style="display:inline;">aMule 日志</h1>
		<a href="log.php?rstlog=1" target="logframe" onclick="return confirm('Do you really want to reset aMule log?')">(重置)</a><br>
	<iframe width="100%" height="400" name="logframe" src="log.php"></iframe>
                  </td>
                  </tr><tr>
                  <td>
		<h1 style="display:inline;">服务器信息</h1>
		<a href="log.php?rstsrv=1" target="srvframe" onclick="return confirm('Do you really want to reset Serverinfo?')">(重置)</a>
<iframe width="100%" height="200" name="srvframe" src="log.php?show=srv"></iframe>
                  </td>
                  </tr>
                </tr>
