  ...
  <tr align="center" valign="top"> 
    <td colspan="2">
      ...
      <td bgcolor="#FFFFFF"><table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
              <tr> 
                <th width="3%"></th>
                <th width="22%" ><a href="amuleweb-main-servers.php?sort=name">服务器名称</a></th>
                <th width="42%" ><a href="amuleweb-main-servers.php?sort=desc">描述</a></th>
                <th width="19%">地址</th>
                <th width="7%"><a href="amuleweb-main-servers.php?sort=users">用户</a></th>
                <th width="7%"><a href="amuleweb-main-servers.php?sort=files">文件</a></th>
