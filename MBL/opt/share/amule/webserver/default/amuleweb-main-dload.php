...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <td width="100%" height="64" align="right" background="images/fond_haut.png"> <table border="0" cellspacing="0" cellpadding="0">
        <tr> 
          ...
          <td width="190" align="right" class="texteinv"><a href="login.php">退出</a><br>
            <a href="amuleweb-main-log.php">日志 &bull;</a> <a href="amuleweb-main-prefs.php">设置</a>
            </td>
          <td width="10"></td>
        </tr>
      </table></td>
  ...
  <tr>
    ...
    <td bgcolor="#FFFFFF"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr> 
                  <th>&nbsp;</th>
                  <th><a href="amuleweb-main-dload.php?sort=name">文件名</a></th>
                  <th><a href="amuleweb-main-dload.php?sort=size">大小</a></th>
                  <th><a href="amuleweb-main-dload.php?sort=size_done">已完成</a></th>
                  <th><a href="amuleweb-main-dload.php?sort=speed">下载速度</a></th>
                  <th><a href="amuleweb-main-dload.php?sort=progress">进度</a></th>
                  <th><a href="amuleweb-main-dload.php?sort=srccount">来源</a></th>
                  <th><a href="amuleweb-main-dload.php?sort=status">状态</a></th>
                  <th><a href="amuleweb-main-dload.php?sort=prio">优先顺序</a></th>
