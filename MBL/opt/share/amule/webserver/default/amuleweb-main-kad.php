            ...
            <td bgcolor="#FFFFFF"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr valign="top"> 
                  ...
                  <td valign="top"> <table  border="0" align="center" cellpadding="0" cellspacing="6" class="kadnewnode">
                      <tr> 
                        <th colspan="2">Bootstrap from node(机翻=系统启动时从节点)</th>
                      </tr>
                      <tr> 
                      ...
                      <tr> 
                        <td align="right">端口 :</td><td align="left"><input name="port" type="text" id="port3" size="4" maxlength="5"> 
                          &nbsp; <input type="submit" name="Submit" value="连接"></td>
                      </tr>
                    </table></td>
                </tr>
                <tr valign="top"> 
                  <td height="20" width="500" align="center">节点数量</td>
                  <td></td>
                </tr>
              </table></td>
